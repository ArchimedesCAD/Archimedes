...
public class SemilineTest extends Tester {
	...
	public void testContainsWorksWithValidPoints() throws Exception {
		...
		assertTrue("Should contain the point " + p1.toString(),
				sline.contains(p1));
		assertTrue("Should contain the point " + p2.toString(),
				sline.contains(p2));
		assertTrue("Should contain the point " + p3.toString(),
				sline.contains(p3));
		assertTrue("Should contain the point " + p4.toString(),
				sline.contains(p4));
		assertFalse("Should not contain the point " + p5.toString(),
				sline.contains(p5));
		assertFalse("Should not contain the point " + p6.toString(),
				sline.contains(p6));
		assertFalse("Should not contain the point " + p7.toString(),
				sline.contains(p7));
	...
	public void testReferencePoints() throws Exception {
		...
		Collection<ReferencePoint> references = sl.getReferencePoints(new Rectangle(
				-10, -10, -100, -100));
	...
	public void testGetOnePointCrossingVertically() throws Exception {
		...
		pointsCrossing = new Semiline(new Point(0, 0), new Point(0, -100)).getPointsCrossing(new Rectangle(
				-50, -50, 50, 50));
		assertEquals(Collections.singletonList(new Point(0, -50)),
				pointsCrossing);
	...
	public void testGetOnePointCrossingHorizontally() throws Exception {
		...
		pointsCrossing = new Semiline(new Point(0, 0), new Point(100, 0)).getPointsCrossing(new Rectangle(
				-50, -50, 50, 50));
		assertEquals(Collections.singletonList(new Point(50, 0)),
				pointsCrossing);
	}
	...
	public void testGetOnePointCrossing() throws Exception {
		...
		pointsCrossing = new Semiline(new Point(0, 0), new Point(100, 100)).getPointsCrossing(new Rectangle(
				-50, -50, 100, 50));
	...
	public void testGetTwoPointsCrossingVertically() throws Exception {
		...
		Collection<Point> pointsCrossing = new Semiline(new Point(0, 0),
				new Point(0, 100)).getPointsCrossing(new Rectangle(-50, 10, 50,
				60));
		expected.clear();
	...
	public void testGetTwoPointsCrossing() throws Exception {
		...
		pointsCrossing = new Semiline(0, 100, 100, 0).getPointsCrossing(new Rectangle(
				10, 10, 90, 90));
		expected.clear();
	...
	@Test
	public void boundaryRectangleShouldContainTheInitialPointAndBeZeroSized()
			throws Exception {
		Rectangle boundaryRectangle = sl.getBoundaryRectangle();
		assertNotNull(boundaryRectangle);
		assertEquals(sl.getInitialPoint(), boundaryRectangle.getLowerLeft());
		assertEquals(0.0, boundaryRectangle.getHeight());
		assertEquals(0.0, boundaryRectangle.getWidth());
	}
}
