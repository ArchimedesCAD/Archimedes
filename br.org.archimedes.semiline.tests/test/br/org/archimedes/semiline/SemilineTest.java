...
public class SemilineTest extends Tester {
	...
	public void testIsPositiveDirection() throws Exception {
		...
		assertTrue("The point should be left of the line",
				getDirection(sline, point));

		point = new Point(0.0, -1.0);
		assertFalse("The point should be right of the line",
				getDirection(sline, point));
	...
	public void testGetNoPointsCrossing() throws Exception {
		...
		pointsCrossing = new Semiline(new Point(-50, -100),
				new Point(100, -100)).getPointsCrossing(new Rectangle(0, 0,
				100, 100));
		assertEquals(Collections.emptyList(), pointsCrossing);
