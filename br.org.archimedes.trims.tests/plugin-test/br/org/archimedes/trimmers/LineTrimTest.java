...
public class LineTrimTest extends Tester {
	...
	@Test
	public void testNullcutPointsArgument() throws InvalidArgumentException,
	...
	@Test
	public void lineTrimsCenter() throws NullArgumentException,
			InvalidArgumentException {
		cutPoints.add(new Point(0.0, 2.0));
		cutPoints.add(new Point(2.0, 2.0));
		Line line = new Line(new Point(-1.0, 2.0), new Point(3.0, 2.0));
		Collection<Element> collection = trimmer.trim(line, cutPoints,
				new Point(1.0, 2.0));

		assertCollectionContains(collection, new Line(new Point(-1.0, 2.0),
				new Point(0.0, 2.0)));
		assertCollectionContains(collection, new Line(new Point(2.0, 2.0),
				new Point(3.0, 2.0)));
		Assert.assertEquals(
				"A trim at the middle of cutPoints should produce 2 lines.", 2,
				collection.size());
	}

	@Test
	public void lineTrimsEndingPortionOfLine() throws NullArgumentException,
			InvalidArgumentException {
		cutPoints.add(new Point(0.0, 2.0));
		cutPoints.add(new Point(2.0, 2.0));
		Line line = new Line(new Point(-1.0, 2.0), new Point(3.0, 2.0));
		...
		assertCollectionContains(collection, new Line(new Point(0.0, 2.0),
				new Point(3.0, 2.0)));
		Assert.assertEquals("A trim at the end of line should produce 1 lines",
				1, collection.size());
	}

	@Test
	public void lineTrimsExtremePoint() throws NullArgumentException,
			InvalidArgumentException {
		cutPoints.add(new Point(0.0, 2.0));
		cutPoints.add(new Point(2.0, 2.0));
		...
		assertCollectionContains(collection, new Line(new Point(-1.0, 2.0),
				new Point(0.0, 2.0)));
		Assert.assertEquals(
				"A trim at the begginning of line should produce 1 lines", 1,
				collection.size());
	}

	@Test
	public void lineDoesntTrimWhenHasNoIntersections()
			throws NullArgumentException, InvalidArgumentException {
		Collection<Point> emptyList = Collections.emptyList();
		Line line = new Line(new Point(0.5, 2.0), new Point(1.5, 2.0));
		Collection<Element> collection = trimmer.trim(line, emptyList,
				new Point(1.0, 2.0));
	...
	@Test
	public void lineTrimsTheLefterPartWhenClickingExactlyOnIntersectionPoint()
			throws NullArgumentException, InvalidArgumentException {
		cutPoints.add(new Point(0.0, 2.0));
		cutPoints.add(new Point(2.0, 2.0));
		Line line = new Line(new Point(-1.0, 2.0), new Point(3.0, 2.0));
		...
		assertCollectionContains(collection, new Line(new Point(2.0, 2.0),
				new Point(3.0, 2.0)));
		Assert.assertEquals(
				"A trim at an intersection of line removes the lefter part", 2,
				collection.size());
	}
}
