...
public class PolylineTrimTest extends Tester {
	...
	public void oneIntersectionReturnsPolyline() throws NullArgumentException,
		...
		Collection<Element> smallerSide = trimmer.trim(poly1, cutPoints,
				new Point(0.0, 0.0));
		...
		Collection<Element> biggerSide = trimmer.trim(poly1, cutPoints,
				new Point(0.0, -1.0));
	...
	@Test
	public void twoIntersectionsReturnTwoPolylinesClickingUp()
	...
	@Test
	public void twoIntersectionsReturnPolylineClickingDown()
			throws NullArgumentException, InvalidArgumentException {
	...
	public void oneIntersectionThroughOriginReturnsLowerPartOfThePolylineClickingUp()
		...
		Collection<Element> sideBelow = trimmer.trim(poly1, cutPoints,
				new Point(1.0, 1.0));
	...
	@Test
	public void oneIntersectionThroughOriginReturnsOnePolyline()
			throws NullArgumentException, InvalidArgumentException {

		cutPoints.add(new Point(0.0, 0.0));

		Collection<Element> sideOver = trimmer.trim(poly1, cutPoints,
				new Point(0.0, -1.0));
		List<Point> expectedPolyPoints = new ArrayList<Point>();
	...
	public void fourIntersectionsReturnTwoPolylinesClickingPolylineBeforeSecondPiece()
		...
		Collection<Element> twoPieces = trimmer.trim(poly1, cutPoints,
				new Point(-1.0, 0.0));
	...
	public void polylineIntersectingItselfThreeTimesWithLineIntersectingThereReturnsRWhenClickedOnLeft()
		...
		Collection<Element> r = trimmer.trim(poly, cutPoints, new Point(-1.0,
				0.5));
		...
		assertCollectionTheSame(
				Collections.singleton(new Polyline(expectedPoints)), r);
	}
}
