...
public class CircleTrimTest extends Tester {
	...
	@Test
	public void singleIntersectionDoesNotTrimCircle()
			throws NullArgumentException, InvalidArgumentException {

		Collection<Element> trimmed = trimmer
				.trim(testCircle, Collections.singleton(new Point(1.0, 0.0)),
						new Point(0.0, 1.0));
		assertCollectionTheSame(Collections.singleton(testCircle), trimmed);
	}

	@Test
	public void twoIntersectionPointsTrimCircleResultsHalfCircle()
			throws NullArgumentException, InvalidArgumentException {

		Collection<Point> cutPoints = new ArrayList<Point>();
		cutPoints.add(new Point(0.0, 1.0));
		cutPoints.add(new Point(0.0, -1.0));
		Collection<Element> trimmed = trimmer.trim(testCircle, cutPoints,
				new Point(1.0, 0.0));
	...
	public void emptyIntersectionListDoesntTrimCircle()
		...
		Collection<Element> trimmed = trimmer.trim(testCircle, emptyList,
				new Point(1.0, 0.0));
		assertCollectionTheSame(Collections.singleton(testCircle), trimmed);
	}
}
