...
public class IsACollectionEquivalentTo<T extends Collection<Element>> extends
		ArgumentMatcher<Collection<Element>> {
	...
	@Factory
	public static <T extends Collection<Element>> IsACollectionEquivalentTo<T> isACollectionEquivalentTo(
