...
public class ArcTrimTest extends Tester {
    ...
    @Test
    public void tangentLineTrimArcResultsHalfArc () throws NullArgumentException,
            InvalidArgumentException {

        Element line = new Line(new Point( -1.0, 1.0), new Point(1.0, 1.0));
        Collection<Element> trimmed = trimmer.trim(testArc, Collections.singleton(line), new Point(
                1.0, 0.0));
    ...
    @Test
    public void lineIntersectsArcOnceReturnsQuarterCircle () throws NullArgumentException,
            InvalidArgumentException {
    ...
    @Test
    public void lineIntersectsExtremePointsOfArcReturnsSameArc () throws NullArgumentException,
            InvalidArgumentException {
    ...
    @Test
    public void lineIntersectsArcTwiceReturnsTwoArcsWhenClickedOverLine ()
        ...
        expected.add(new Arc(new Point(1.0, 0.0), new Point(Math.sqrt(3.0) / 2.0, 0.5), new Point(
                0.0, 0.0), true));
        expected.add(new Arc(new Point( -Math.sqrt(3.0) / 2.0, 0.5), new Point( -1.0, 0.0),
                new Point(0.0, 0.0), true));
    ...
    @Test
    public void lineDoesntIntersectArcWouldIfArcWasCircleReturnsSameArc ()
            throws NullArgumentException, InvalidArgumentException {
    ...
    @Test
    public void twoLinesIntersectArcReturnsThreeQuartersOfArc () throws NullArgumentException,
            InvalidArgumentException {
        ...
        assertCollectionTheSame(Collections.singleton(new Arc(new Point(cos45, cos45), new Point(
                0.0, 1.0), new Point( -1.0, 0.0))), trimmed);
    }

    @Test
    public void lineInExtremeOfArcReturnsSameArc () throws Exception {

        Collection<Element> references = new ArrayList<Element>();
        references.add(new Line(new Point( -2.0, 0.0), new Point(0.0, 0.0)));
        Collection<Element> trimmed = trimmer.trim(testArc, references, new Point( -1.0, 0.0));
        assertCollectionTheSame(Collections.singleton(testArc), trimmed);
    }
}
