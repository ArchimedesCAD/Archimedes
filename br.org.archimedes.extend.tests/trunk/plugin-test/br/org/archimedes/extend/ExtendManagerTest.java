...
public class ExtendManagerTest extends Tester{
    @Test
    public void testeNaoModificaElementoComUmExtenderNaoExistente() throws Exception {
    ...
    public void testeChamaExtenderMockadoParaExtenderExistente() throws Exception {
