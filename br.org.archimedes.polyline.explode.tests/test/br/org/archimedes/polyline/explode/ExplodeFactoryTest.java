...
public class ExplodeFactoryTest extends FactoryTester {
	...
	@Test
	public void testExplodeWithPresetValidSelection()
	...
	@Test
	public void testIgnoresPresetSelectionIfNotValid()
			throws InvalidArgumentException {
	...
	private Element createSafePolyLine(List<Point> points) {
		...
		try {
			...
			Assert.fail("Should not throw a NullArgumentException while creating the polyline");
		} catch (InvalidArgumentException e) {
			Assert.fail("Should not throw a InvalidArgumentException while creating the polyline");
		}
		return result;
	}
