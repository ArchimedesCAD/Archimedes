...
@RunWith(Suite.class)
@Suite.SuiteClasses({ ActiveStateTest.class, ArcArcIntersectorTest.class,
		ArcExporterTest.class, ArcExtenderTest.class, ArcFactoryTest.class,
		ArcInfiniteLineIntersectorTest.class, ArcLineIntersectorTest.class,
		ArcTest.class, ArcTrimTest.class, AreaPerimeterFactoryTest.class,
		CircleExporterTest.class, CircleFactoryTest.class,
		CircleLineIntersectorTest.class, CirclePolylineIntersectorTest.class,
		CircleTest.class, CircleTrimTest.class, CommandParserTest.class,
		CopyPasteFactoryTest.class, CopyToClipboardFactoryTest.class,
		DefaultFilleterTest.class, DimensionExporterTest.class,
		DimensionFactoryTest.class, DimensionParserTest.class,
		DimensionTest.class, DistanceFactoryTest.class,
		...
		LineExporterTest.class, LineExtenderTest.class, LineFactoryTest.class,
		LineInfiniteLineIntersectorTest.class, LineLeaderIntersectorTest.class,
		LineLineIntersectorTest.class, LineParserTest.class,
		LinePolylineIntersectorTest.class, LineTest.class,
		LineTextIntersectorTest.class, LineTrimTest.class,
		LoadCommandTest.class, MacroCommandTest.class, MirrorFactoryTest.class,
		MousePositionManagerTest.class, MoveCommandTest.class,
		MoveElementTest.class, MoveFactoryTest.class, OffsetFactoryTest.class,
		OrtoCommandTest.class, PanCommandTest.class, PanCommandTest.class,
		PasteFactoryTest.class, PointTest.class, PolyLineFactoryTest.class,
		PolyLineTest.class, PolylineExporterTest.class,
		PolylineExtenderTest.class, PolylinePolylineIntersectorTest.class,
		PolylineTrimTest.class, PutElementTest.class,
		RectangleFactoryTest.class, RectangleTest.class, RedoTest.class,
		RemoveElementTest.class, RotateFactoryTest.class, RotateTest.class,
		SVGExporterHelperTest.class, SVGExporterTest.class,
		SaveCommandTest.class, ScaleFactoryTest.class, SelectionTest.class,
		SemilineArcIntersectorTest.class, SemilineCircleIntersectorTest.class,
		SemilineExporterTest.class, SemilineExtenderTest.class,
		SemilineInfiniteLineIntersectorTest.class,
		SemilineLineIntersectorTest.class,
		SemilinePolylineIntersectorTest.class,
		SemilineSemilineIntersectorTest.class, SemilineTest.class,
		SemilineTrimTest.class, SimpleSelectionParserTest.class,
		SnapTest.class, StretchFactoryTest.class, TextExporterTest.class,
		TextParserTest.class, TextTest.class, TrimCommandTest.class,
		TrimManagerTest.class, TrimTest.class, UndoTest.class, UtilsTest.class,
		VectorParserTest.class, VectorTest.class,
		VerticalInfiniteLineTest.class, VisualHelperTest.class,
		WorkspaceTest.class, XMLExporterHelperTest.class,
		XMLExporterTest.class, XMLImporterTest.class,
		ZoomByAreaCommandTest.class, ZoomFactoryTest.class,
