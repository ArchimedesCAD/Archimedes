...
public class EditTextCommand implements UndoableCommand {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.org.archimedes.controller.commands.UndoableCommand#undoIt(br.org.
	 ...
	 * 
	 * @see
	 * br.org.archimedes.controller.commands.Command#doIt(br.org.archimedes.
	 * model.Drawing)
	 */
	...
	protected TextEditor getTextEditor() {
		...
		return new TextEditor(PlatformUI.getWorkbench()
				.getActiveWorkbenchWindow().getShell(), text.getText());
	}
