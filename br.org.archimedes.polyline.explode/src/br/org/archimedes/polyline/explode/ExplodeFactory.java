...
public class ExplodeFactory extends SelectorFactory {
	 ...
	 */
	private UndoableCommand remove(Polyline polyLine)
			throws NullArgumentException {
	 ...
	 * @return An undoable command that inserts all lines composing this
	 *         polyline
	 * @throws NullArgumentException
	 *             Should never be thrown
	 */
	private UndoableCommand explode(Polyline polyLine)
			throws NullArgumentException {
