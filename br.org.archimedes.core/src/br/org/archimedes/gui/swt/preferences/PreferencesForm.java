...
public class PreferencesForm extends Observable implements Observer {
	...
	private void createForm(Composite parent) {
		...
		messages.put(PreferencesForm.background + "Label",
				Messages.PreferencesEditor_BackgroundColorLabel);
		messages.put(PreferencesForm.background + "Change",
				Messages.PreferencesEditor_BackgroundColorChange);
		messages.put(PreferencesForm.cursor + "Label",
				Messages.PreferencesEditor_CursorColorLabel);
		messages.put(PreferencesForm.cursor + "Change",
				Messages.PreferencesEditor_CursorColorChange);
		messages.put(PreferencesForm.gripSelection + "Label",
				Messages.PreferencesEditor_GripSelectionColorLabel);
		messages.put(PreferencesForm.gripSelection + "Change",
				Messages.PreferencesEditor_GripSelectionColorChange);
		messages.put(PreferencesForm.gripMouseOver + "Label",
				Messages.PreferencesEditor_GripMouseOverColorLabel);
		messages.put(PreferencesForm.gripMouseOver + "Change",
				Messages.PreferencesEditor_GripMouseOverColorChange);
	...
	private void createColorField(Group formGroup, final String element) {
		...
		allCanvas.get(element).setBackground(
				new org.eclipse.swt.graphics.Color(parent.getDisplay(), color
