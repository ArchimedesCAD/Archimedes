...
public class CanvasWithSlider {
	 ...
	 */
	public CanvasWithSlider(Composite parent, int canvasSize, int defaultValue,
			Color color) {

		this(parent, canvasSize, defaultValue, OpenGLWrapper.CONTINUOUS_LINE,
				color);
	}
