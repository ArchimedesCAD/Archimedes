...
public class WorkspacePropertiesDialog {
	...
	private void createShell() {
		...
		shell.addDisposeListener(new DisposeListener() {
			...
			public void widgetDisposed(DisposeEvent arg0) {
				...
				br.org.archimedes.Utils.getOpenGLWrapper().setCurrentCanvas(
						null);
	...
	private void createAndLayThingsOut() {
		...
		mouseSize = new CanvasWithSlider(shell, CANVAS_SIZE,
				(int) workspace.getMouseSize(), OpenGLWrapper.COLOR_CURSOR);
		...
		gripSize = new CanvasWithSlider(shell, CANVAS_SIZE,
				(int) workspace.getGripSize(), OpenGLWrapper.COLOR_SELECTED);
