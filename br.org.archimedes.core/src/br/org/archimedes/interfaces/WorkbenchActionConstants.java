...
public interface WorkbenchActionConstants {
	 ...
	 * <code>IWorkbenchActionConstants.NEW_EXT</code>, i.e.,
	 * <code>"new.ext"</code>).
	 */
	 ...
	 * <code>IWorkbenchActionConstants.CLOSE_EXT</code>, i.e.,
	 * <code>"close.ext"</code>).
	 */
	 ...
	 * <code>IWorkbenchActionConstants.SAVE_EXT</code>, i.e.,
	 * <code>"save.ext"</code>).
	 */
	 ...
	 * <code>IWorkbenchActionConstants.PRINT_EXT</code>, i.e.,
	 * <code>"print.ext"</code>).
	 */
	 ...
	 * <code>IWorkbenchActionConstants.IMPORT_EXT</code>, i.e.,
	 ...
	 * <code>IWorkbenchActionConstants.MRU</code>, i.e., <code>"mru"</code>).
	 */
	public static final String MRU = IWorkbenchActionConstants.MRU;
	/**
	 * File menu: name of group for end of menu (value
	 * <code>IWorkbenchActionConstants.FILE_END</code>, i.e.,
	 * <code>"fileEnd"</code>).
	 */
	 ...
	 * <code>IWorkbenchActionConstants.M_EDIT</code>, i.e., <code>"edit"</code>
	 * ).
	 */
	public static final String M_EDIT = IWorkbenchActionConstants.M_EDIT;
	/**
	 * Edit menu: name of group for start of menu (value
	 * <code>IWorkbenchActionConstants.EDIT_START</code>, i.e.,
	 * <code>"editStart"</code>).
	 */
	public static final String EDIT_START = IWorkbenchActionConstants.EDIT_START;
	/**
	 * Edit menu: name of group for extra Clipboad-like actions (value
	 * <code>"clipboard.ext"</code>).
	 */
	public static final String CLIPBOAD_EXT = "clipboard.ext";
	/**
	 * Edit menu: name of group for extra Selection-like actions (value
	 * <code>"selection.ext"</code>).
	 */
	public static final String SELECTION_EXT = "selection.ext";
	/**
	 * Edit menu: name of group for extra Workspace Modification-like actions
	 * (value <code>"workmods.ext"</code>).
	 */
	public static final String WORKSPACE_MODIFICATIONS_EXT = "workmods.ext";
	/**
	 * Edit menu: name of group for end of menu (value
	 * <code>IWorkbenchActionConstants.EDIT_END</code>, i.e.,
	 * <code>"editEnd"</code>).
	 */
	...
	/**
	 * Create menu: name of group for start of menu (value
	 * <code>"createStart"</code>).
	 */
	public static final String CREATE_START = "createStart"; //Group //$NON-NLS-1$
	/**
	 * Create menu: name of group for end of menu (value
	 * <code>"createEnd"</code>).
	 */
	...
	/**
	 * Tranform menu: name of group for start of menu (value
	 * <code>"tranformStart"</code>).
	 */
	public static final String TRANSFORM_START = "tranformStart"; //Group //$NON-NLS-1$
	/**
	 * Tranform menu: name of group for end of menu (value
	 * <code>"tranformEnd"</code>).
	 */
	public static final String TRANSFORM_END = "tranformEnd"; //Group //$NON-NLS-1$

	/**
	 * Name of group for adding new top-level menus (value
	 * <code>IWorkbenchActionConstants.MB_ADDITIONS</code>, i.e.,
	 * <code>"additions"</code>).
	 */
