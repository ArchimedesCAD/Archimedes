...
public class SelectionState extends InputState {
	...
	public String receiveText(String text) {
		...
		if (command != null && command.isDone() && !nextShould) {
			try {
				selectionCount = br.org.archimedes.Utils.getController()
						.getActiveDrawing().getSelection()
	 ...
	 * 
	 * @see
	 * br.org.archimedes.controller.InputState#setCurrentFactory(br.org.archimedes
