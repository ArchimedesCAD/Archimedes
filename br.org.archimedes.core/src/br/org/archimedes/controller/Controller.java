...
public class Controller {
	 ...
	 * Do NOT call this constructor. This only exists to allow the Activator to
	 * call it.<br>
	 * To acquire an instance of this controller, refer to
	 * Utils.getController().
	 */
	public Controller() {
	...
	/**
	 * Sets the current drawing. Also sets the
	 * br.org.archimedes.Utils.getWorkspace() viewport to this drawing's
	 * viewport.
	 * 
	 * @param drawing
	 ...
	 * @return The selected element (closest to the point) or null if the
	...
	private Element getClosests(Collection<Element> elements, Point point) {
		...
		for (Element element : elements) {
			try {
				...
				System.err
						.println("Couldnt calculate a distance for " + element //$NON-NLS-1$
	...
	public boolean select(Point p1, Point p2, boolean invertSelection)
		...
		Rectangle rect = new Rectangle(p1.getX(), p1.getY(), p2.getX(),
				p2.getY());
