...
public abstract class SelectionPointVectorFactory implements CommandFactory {
	...
	public String next(Object parameter) throws InvalidParameterException {
		...
		if (isDone() || parameter == null) {
			...
			if (reference != null) {
				reference = null;
				result = Messages.ReferenceUndone + Constant.NEW_LINE
						+ Messages.SelectionPointVector_Iteration2;
			} else {
				selection = null;
				result = Messages.SelectionUndone + Constant.NEW_LINE
						+ Messages.SelectionPointVector_Iteration1;
			}
	...
	public void drawVisualHelper() {
		...
		if (!isDone() && reference != null && vector == null) {
			...
			try {
				...
				br.org.archimedes.Utils.getOpenGLWrapper().drawFromModel(start,
						end);
