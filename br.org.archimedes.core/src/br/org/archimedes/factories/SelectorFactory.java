...
/**
 * Belongs to package br.org.archimedes.factories. NOTA: Factories that will
 * handle double clicks must extend SelectorFactory. After all, it makes sense
 * that the first step of a factory that will handle double clicks is a
