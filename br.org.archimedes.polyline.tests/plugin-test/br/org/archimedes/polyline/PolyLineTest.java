...
public class PolyLineTest extends Tester {
	...
	@Test
	public void testIsPositiveDirectionForM() throws NullArgumentException,
			InvalidArgumentException {
		Polyline polyline = new Polyline(new Point(-10, 0), new Point(-5, 10),
				new Point(0, 0), new Point(5, 10), new Point(10, 0));
	...
	@Test
	public void testIsPositiveDirectionFor4() throws NullArgumentException,
			InvalidArgumentException {
		Polyline polyline = new Polyline(new Point(0, 0), new Point(0, 10),
	...
	@Test
	public void testIsPositiveDirectionForTie() throws NullArgumentException,
			InvalidArgumentException {
		Polyline polyline = new Polyline(new Point(0, 0), new Point(0, 10),
				new Point(-5, 5), new Point(5, 5), new Point(0, 0));
		boolean expected, result;
