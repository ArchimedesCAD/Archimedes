...
public class ArcArcIntersectorTest extends Tester {
	...
	@Test
	public void arcCompletesACircleReturnsTwoIntersectionPoints() throws NullArgumentException, InvalidArgumentException {
		Arc arc = new Arc(new Point(0.0, 0.0), new Point(1.0, -1.0), new Point(2.0, 0.0));
	...
	@Test
	public void arcCrossesOneSideReturnsOneIntersectionPoint() throws NullArgumentException, InvalidArgumentException {
		Arc arc = new Arc(new Point(2.0, 2.0), new Point(1.0, 1.0), new Point(1.5, 0.5));
