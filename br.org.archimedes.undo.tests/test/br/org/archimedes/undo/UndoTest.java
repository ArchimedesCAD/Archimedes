...
public class UndoTest {
	...
	public void testDoIt() {
		...
		Assert.assertEquals("The undo history size is wrong.", 2,
				undoHistory.size());
		Assert.assertEquals("The first element in the undo history is wrong",
				commands.get(commands.size() - 3), undoHistory.peek());
		Assert.assertEquals("The redo history size is wrong.", 1,
				redoHistory.size());
		...
		Assert.assertEquals("The undo history size is wrong.", 1,
				undoHistory.size());
		Assert.assertEquals("The first element in the undo history is wrong",
				commands.get(commands.size() - 4), undoHistory.peek());
		Assert.assertEquals("The redo history size is wrong.", 2,
				redoHistory.size());
		Assert.assertEquals("The first element in the redo history is wrong",
		...
		Assert.assertEquals("The undo history size is wrong.", 0,
				undoHistory.size());
		Assert.assertEquals("The redo history size is wrong.", 3,
				redoHistory.size());
		Assert.assertEquals("The first element in the redo history is wrong",
