...
public class GlyfCompositeDescript extends GlyfDescript {
	...
	private Vector<GlyfCompositeComp> components = new Vector<GlyfCompositeComp>();
	...
	public int getPointCount() {
		GlyfCompositeComp c = (GlyfCompositeComp) components
				.elementAt(components.size() - 1);
		return c.getFirstIndex()
				+ parentTable.getDescription(c.getGlyphIndex()).getPointCount();
	}
