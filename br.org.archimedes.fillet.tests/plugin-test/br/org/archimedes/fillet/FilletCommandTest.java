...
public class FilletCommandTest extends Tester {
	...
	public void throwsNullArgumentExceptionIfFirstPointIsNull()
			throws Exception {
	...
	@Test(expected = NullArgumentException.class)
	public void throwsNullArgumentExceptionIfSecondPointIsNull()
			throws Exception {
	...
	@Test(expected = NullArgumentException.class)
	public void throwsNullArgumentExceptionIfFirstElementIsNull()
			throws Exception {
	...
	@Test(expected = NullArgumentException.class)
	public void throwsNullArgumentExceptionIfSecondElementIsNull()
			throws Exception {
	...
	@Test(expected = NullArgumentException.class)
	public void throwsNullArgumentOnDoItExceptionIfDrawingIsNull()
			throws Exception {
	...
	@Test(expected = NullArgumentException.class)
	public void throwsNullArgumentOnUndoItExceptionIfDrawingIsNull()
			throws Exception {
	...
	public void undoItThrowsIllegalActionExceptionIfCommandWasNotDone()
			throws Exception {
