...
public class RotateFactory implements CommandFactory {
	 ...
	 */
	private void tryGetAngle(Object parameter) throws InvalidParameterException {

		try {
			double baseAngle = Geometrics.calculateAngle(axisP1, axisP2);
			Vector vector = (Vector) parameter;
			double newAngle = Geometrics.calculateAngle(reference,
					reference.addVector(vector));
