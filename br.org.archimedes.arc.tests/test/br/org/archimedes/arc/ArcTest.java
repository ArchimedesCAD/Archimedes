...
public class ArcTest extends Tester {
	...
	@Test
	public void equalsAndHashCodeDontCareAboutHowArcAreCreated()
	...
	public void cloningKeepsSameLayer() throws Exception {
		...
		Layer layer = new Layer(new Color(0, 200, 0), "layer",
	...
	@Test
	public void boundaryRectangleIncludesTheWholeArc()
			throws InvalidArgumentException, NullArgumentException {
	...
	public void anArcShouldContainAllPointsThatBelongToItAndNoOther()
		...
		assertTrue("An arc should contain its own initial point",
				arc1.contains(arc1.getInitialPoint()));
		assertTrue("An arc should contain its own ending point",
				arc1.contains(arc1.getEndingPoint()));
		assertTrue("An arc should contain its own intermediate point",
				arc1.contains(arc1.getIntermediatePoint()));
		Point intermediate = new Point(Math.sqrt(2) / 2.0, Math.sqrt(2) / 2.0);
		assertTrue("An arc should contain other points in it",
				arc1.contains(intermediate));

		assertFalse("An arc should not contain external points",
				arc1.contains(new Point(1, 1)));
		assertFalse("An arc should not contain internal points",
				arc1.contains(center));
	...
	public void canCreateArcWithThreePoints() {
		...
		// Oblique arc
		arcCreationWithThreePoints(1, 1, -Math.sqrt(2.0), Math.sqrt(2.0), -1,
				-1);

	}

	private void arcCreationWithThreePoints(double x1, double y1, double x2,
		...
		Assert.assertEquals(x2, arc4.getIntermediatePoint().getX(),
				Constant.EPSILON);
		Assert.assertEquals(y2, arc4.getIntermediatePoint().getY(),
				Constant.EPSILON);
	...
	@Test
	public void getPointsReturnsThePointsInstancesThatDefineTheArc()
			throws Exception {
	...
	@Test
	public void moveMaitainsTheSameInstancesOfPointsForTheArc()
			throws Exception {
