...
public class SemilineCircleIntersectorTest extends Tester {
	...
	public void testNoIntersections() throws NullArgumentException,
			InvalidArgumentException {
		Semiline testLine = new Semiline(new Point(-10.0, 10.0), new Point(
				10.0, 10.0));
	...
	public void testTangentLine() throws NullArgumentException,
			InvalidArgumentException {
		Semiline testLine = new Semiline(new Point(5.0, -5.0), new Point(5.0,
				5.0));
	...
	public void testTwoIntersections() throws NullArgumentException,
			InvalidArgumentException {
		Semiline testLine = new Semiline(new Point(-10.0, 0.0), new Point(0.0,
				0.0));
		Collection<Point> expected = new ArrayList<Point>();
		expected.add(new Point(-5.0, 0.0));
		expected.add(new Point(5.0, 0.0));
	...
	public void testPartiallyInside() throws NullArgumentException,
			InvalidArgumentException {
		Semiline testLine = new Semiline(new Point(0.0, 0.0), new Point(10.0,
				0.0));
		Collection<Point> expected = new ArrayList<Point>();
		expected.add(new Point(5.0, 0.0));
		assertCollectionTheSame(expected,
	...
	public void testOnePointAtCircle() throws NullArgumentException,
			InvalidArgumentException {
		Semiline testLine = new Semiline(new Point(5.0, 0.0), new Point(10.0,
				0.0));
		Collection<Point> expected = new ArrayList<Point>();
		expected.add(new Point(5.0, 0.0));
		assertCollectionTheSame(expected,
	...
	@Test
	public void testWouldntIntersectCircleIfLine()
			throws NullArgumentException, InvalidArgumentException {
		Semiline testLine = new Semiline(new Point(-10.0, 0.0), new Point(-7.0,
				0.0));
		Collection<Point> expected = new ArrayList<Point>();
		expected.add(new Point(-5.0, 0.0));
		expected.add(new Point(5.0, 0.0));
	...
	public void testNoIntersectionWouldIfInfiniteLine()
			throws NullArgumentException, InvalidArgumentException {
		Semiline testLine = new Semiline(new Point(-7.0, 0.0), new Point(-10.0,
				0.0));
		Collection<Point> intersections = intersector.getIntersections(
				testCircle, testLine);
		assertCollectionTheSame(new ArrayList<Point>(), intersections);
