...
public class EllipseLineIntersectorTest extends Tester {
	...
	public void SetUp() throws NullArgumentException, InvalidArgumentException {
		...
		this.ellipse = new Ellipse(new Point(0, 0), new Point(2, 0), new Point(
				0, 1));
	...
	public void shouldNotReturnIntersectionPoints()
		...
		assertCollectionTheSame(Collections.emptyList(),
				intersector.getIntersections(ellipse, line));
	...
	@Test
	public void shouldReturnOneIntersectionPointRotated()
			throws InvalidArgumentException, NullArgumentException {
		...
		List<Point> intersectionPoints = new ArrayList<Point>();
		intersectionPoints
				.add(new Point(-4.7069360559627, -0.28210643262392987));
