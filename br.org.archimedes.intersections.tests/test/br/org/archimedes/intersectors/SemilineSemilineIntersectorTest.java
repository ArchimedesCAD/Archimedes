...
public class SemilineSemilineIntersectorTest extends Tester {
	...
	@Test
	public void simpleSemilineIntersection() throws InvalidArgumentException,
	...
	@Test
	public void paralelsSemilinesIntersection()
	...
	@Test
	public void sameSemilineIntersection() throws InvalidArgumentException,
			NullArgumentException {
		SemilineSemilineIntersector lli = new SemilineSemilineIntersector();
	...
	@Test
	public void subSemilineIntersection() throws InvalidArgumentException,
			NullArgumentException {
		SemilineSemilineIntersector lli = new SemilineSemilineIntersector();
		Semiline line1 = new Semiline(2, 2, 12, 12);
	...
	public void noSemilineIntersectionWouldIfOneExtended()
			throws InvalidArgumentException, NullArgumentException {
		SemilineSemilineIntersector lli = new SemilineSemilineIntersector();
		Semiline line1 = new Semiline(2, 2, 12, 12);
	...
	public void noSemilineIntersectionWouldIfTwoExtended()
			throws InvalidArgumentException, NullArgumentException {
		SemilineSemilineIntersector lli = new SemilineSemilineIntersector();
		Semiline line1 = new Semiline(2, 2, 12, 12);
