...
public class InfiniteLineInfiniteLineIntersectorTests extends Tester {
	...
	public void setup() throws NullArgumentException, InvalidArgumentException {
		infiniteLine = new InfiniteLine(new Point(0.0, 1.0),
				new Point(1.0, 1.0));
		intersector = new InfiniteLineInfiniteLineIntersector();
	}

	@Test
	public void concurrentInfinitelineInfiniteLineIntersector()
			throws Exception {
		...
		Collection<Point> intersections = intersector.getIntersections(
				otherInfiniteLine, infiniteLine);
		assertCollectionTheSame(Collections.singleton(p0), intersections);
		intersections = intersector.getIntersections(infiniteLine,
				otherInfiniteLine);
		assertCollectionTheSame(Collections.singleton(p0), intersections);
	}

	@Test
	public void paralelsInfiniteLinesIntersection()
	...
	@Test
	public void coincidentLineIntersection() throws InvalidArgumentException,
