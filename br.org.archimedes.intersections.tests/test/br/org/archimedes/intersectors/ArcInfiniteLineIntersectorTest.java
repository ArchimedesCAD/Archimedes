...
public class ArcInfiniteLineIntersectorTest extends Tester {
	...
	public void setUp() throws NullArgumentException, InvalidArgumentException {
		...
		testArc = new Arc(new Point(-5.0, 0.0), new Point(0.0, 5.0), new Point(
				5.0, 0.0));
	}
	...
	@Test
	public void infinitelineNotIntersectingArcReturnsNoIntersections()
			throws NullArgumentException, InvalidArgumentException {
		InfiniteLine infiniteline = new InfiniteLine(new Point(-5.0, 10.0),
				new Point(5.0, 10.0));

		Collection<Point> intersections = intersector.getIntersections(testArc,
				infiniteline);
		assertCollectionTheSame(Collections.emptyList(), intersections);
	}

	@Test
	public void infinitelineIntersectsArcTwiceReturnsTwoIntersectionPoints()
			throws NullArgumentException, InvalidArgumentException {
		InfiniteLine infiniteline = new InfiniteLine(new Point(-4.0, 0.0),
				new Point(4.0, 0.0));
	...
	@Test
	public void infinitelineIntersectsArcOnceReturnsOneIntersectionPoint()
			throws NullArgumentException, InvalidArgumentException {
		InfiniteLine infiniteline = new InfiniteLine(new Point(0.0, 0.0),
				new Point(0.0, -5.0));
