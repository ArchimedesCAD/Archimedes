...
public class PolygonTests {
	...
	@Test
	public void shouldCreateAPolygonWith4VertexTest()
	...
	public void shouldThrowInvalidArgumentExceptionWhenSidesLessThen3()
			throws NullArgumentException, InvalidArgumentException {
		p = new Polygon(new Point(0.0, 0.0), new Point(1.0, 1.0), 2, false);
	}

	@Test(expected = InvalidArgumentException.class)
	public void shouldThrowInvalidArgumentExceptionWhenPointsAreEqual()
			throws NullArgumentException, InvalidArgumentException {
