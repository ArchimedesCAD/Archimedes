...
public class Leader extends Element {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.org.archimedes.model.elements.Element#move(double, double)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.org.archimedes.model.elements.Element#getBoundaryRectangle()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.org.archimedes.model.elements.Element#getReferencePoints(com
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.org.archimedes.model.elements.Element#getProjectionOf(com.
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.org.archimedes.model.elements.Element#contains(br.org
	...
	public void draw(OpenGLWrapper wrapper) {
		...
		List<Point> circle = getPointsForCircle(pointer.getInitialPoint(),
