...
public class ArcFactory implements CommandFactory {
	...
	public String next(Object parameter) throws InvalidParameterException {
		...
		} else if (isCenterProtocol && point1 != null && point3 != null
				&& point4 == null) {
			if (parameter != null) {
	...
	private void drawCenterProtocolVH(OpenGLWrapper opengl, Point end) {
		...
		try {
			...
			if (point2 == null) {
				 ...
				 * 
				 * Point midPoint = end.clone(); double rotateAngle = 2.8;
				 * midPoint.rotate(point1, rotateAngle);
				 * 
				 * Arc arc = new Arc(point1, midPoint, end); arc.draw(opengl);
				 */
	 ...
	 *            The point to be used as the parameter point.
	 */
	private void drawDefaultProtocolVH(OpenGLWrapper opengl, Point end) {
