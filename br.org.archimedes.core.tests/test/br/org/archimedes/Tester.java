...
public abstract class Tester {
	...
	public void assertCollectionTheSame(Collection<? extends Object> expected,
		...
		Assert.assertTrue("The expected collection " + expectedList
				+ " should contain the actual one " + realList,
				expectedList.containsAll(realList));
		Assert.assertTrue("The actual collection " + realList
				+ " should contain the expected one " + expectedList,
				realList.containsAll(expectedList));
	}
