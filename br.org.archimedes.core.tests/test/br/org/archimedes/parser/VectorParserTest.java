...
public class VectorParserTest extends Tester {
	...
	public void testInvalidWithPoint() {
		...
		Assert.assertEquals("Should have a vector parameter.", new Vector(
				new Point(0, 0), p2), vp.getParameter());
	}
	...
	private Parser createNewParser(Point p1) {
		...
		Assert.assertNull("Should have no parameter yet.",
				parser.getParameter());
		return parser;
	}
