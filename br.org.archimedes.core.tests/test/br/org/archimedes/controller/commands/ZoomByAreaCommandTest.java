...
public class ZoomByAreaCommandTest {
	...
	public void testZoomByAreaCommandConstructor() {
		...
		try {
			...
			Assert.assertEquals("Should throw an IllegalActionException.",
					IllegalActionException.class, e.getClass());
		}
	}
	...
	private void testZoomByArea(Command command, Point pointExpected,
		...
		Assert.assertEquals(
				"The current viewport should be " + pointExpected.toString(),
				pointExpected, viewport);
